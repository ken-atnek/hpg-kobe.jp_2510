...
import { navMenu } from '@/data/villa/navMenuData'; // 必要に応じて別店舗に切り替え
...
export default function ClientWrapper({
  ...
  const isLeftActive = isMobile
    ? pathname === '/villa/' // スマホは/villa/のみ
    : ['/villa/', '/villa/system/', '/villa/news/'].includes(pathname); // PCは3ページ

  const isAuthPage = pathname.startsWith('/villa/auth');
  ...
  return (
    ...
    >
      {isAuthPage ? (
        ...
        <RequireAge scope="hot" authPath="/villa/auth">
          <>
            <Header
            ...
            <div className={styles.innerMain}>
              ...
              >
                {isLeftActive && (
                  <ShopLeft photoDiaryUrl="https://blogparts.cityheaven.net/widget/?shopId=1800&mode=2&type=14&limitedKind=0&num=9&col=3&color=2&fontsize=12" />
                )}
                {children}
              </main>
            </div>
